...
extension GalleryComponent {
	static let textField: Self = {
		return .init(
			id: "TextField",
			template: #"{"id":"gallery_component","checks":[{"condition":{"call":"email","args":{"value":{"path":"/body/text"}}},"message":"validation failed"}],"component":{"TextField":{"value":{"path":"/body/text"},"label":{"path":"/label"},"variant":"{{\#(textFieldVariantKey)}}"}}}"#,
