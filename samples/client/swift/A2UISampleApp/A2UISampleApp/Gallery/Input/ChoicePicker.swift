...
extension GalleryComponent {
	...
	static let choicePicker: Self = {
		return .init(
			id: "ChoicePicker",
			template: #"{"id":"gallery_component","component":{"ChoicePicker":{"label":{"path":"/label"},"variant":"{{\#(choicePickerVariantKey)}}","options":[{"label":{"path":"/options/0/label"},"value":"option1"},{"label":{"path":"/options/1/label"},"value":"option2"},{"label":{"path":"/options/2/label"},"value":"option3"}],"value":{"path":"/selections"}}}}"#,
			...
			dataModelFields: [
				...
				DataModelField(path: "/selections", label: "Selected", value: .listObjects([]), showInEditor: false),
